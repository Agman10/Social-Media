...
på post så är tanken att alla tables från databasen ska skickas till main sidan varje post skrivs ut på sidan. men databasen är för stor för att det ska gå vilket är problemet error ERR_CONTENT_LENGTH_MISMATCH 200



Paket som ska installeras finns på package-lock.json